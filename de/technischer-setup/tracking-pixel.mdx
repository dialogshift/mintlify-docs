...
<Tabs>
  ...
  <Tab title="Mit eigenen Variablen">
    ```javascript
    <script>
    var pixel = document.createElement("img"); 
...
<Note>
Aus technischen Gründen werden keine Umsätze aus Instagram, Facebook, Google's Business Messages oder WhatsApp erfasst. Die Lösung liefert indikative Zahlen.
</Note>
