...
Damit die Dialog Shift SIP Phone AI in der Lage ist, Anrufe an Nebenstellen innerhalb der Hotel-PBX weiterzuleiten, müssen einige Konfigurationen sichergestellt werden. 

<Note>
  Vorraussetzung: DialogShift Phone AI ist erfolgreich in der PBX angemeldet.
</Note>

Die Phone AI leitet einen Anruf weiter, indem sie einen neuen Anruf innerhalb der PBX initiiert und danach den Anruf des Gastes mit der neuen Strecke verbindet.

Hier die von der Phone AI gesendete SIP Invite:

```log [expandable]

<--- Transmitting SIP request (1262 bytes) to UDP:37.120.180.223:5060 --->
INVITE sip:11@intermar.starface-cloud.com:5060 SIP/2.0
Via: SIP/2.0/UDP 167.235.196.85:5071;rport;branch=z9hG4bKPj70b977ae-2263-4456-8119-29c9ef4fa01c
From: <sip:DialogShift@intermar.starface-cloud.com>;tag=1e5d8c21-fee0-4c9c-b0c1-9fcc589fdfcd
To: <sip:11@intermar.starface-cloud.com>
Contact: <sip:DialogShift@167.235.196.85:5071>
...
P-Asserted-Identity: "493057710060" <sip:493057710060@intermar.starface-cloud.com>
Remote-Party-ID: "493057710060" <sip:493057710060@intermar.starface-cloud.com>
Max-Forwards: 70
User-Agent: DialogShift Phone AI Node 1
Authorization: Digest username="DialogShift", realm="STARFACE", nonce="0df98eb4", uri="sip:11@intermar.starface-cloud.com:5060", response="5826fa8a1ccd7aa58025cc2f0e71626a", algorithm=MD5
Content-Type: application/sdp
Content-Length:   237

v=0
o=- 1420236124 1420236124 IN IP4 167.235.196.85
s=VoIP
c=IN IP4 167.235.196.85
t=0 0
